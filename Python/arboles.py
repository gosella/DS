...
class TreeMap():
    ...
    _Root = namedlist('_Root', 'left parent')
    ...
    def begin(self):
        return TreeMap._Coordinate(_minimum_node(self._root))


    def end(self):
        return TreeMap._Coordinate(self._root)
    ...
    def find(self, key):
        def find(node):
            if node is None:
                ...
                return TreeMap._Coordinate(node)
    ...
    def maximum(self):
        return TreeMap._Coordinate(_maximum_node(self._root))
    ...
    def insert(self, key, value):
        def insert(node, parent):
            if node is None:
                ...
                coord = TreeMap._Coordinate(node)
            elif key < node.key:
    ...
    class _Coordinate():
        ...
        def next(self):
            return TreeMap._Coordinate(self._node).advance()
        ...
        def prev(self):
            return TreeMap._Coordinate(self._node).retreat()
