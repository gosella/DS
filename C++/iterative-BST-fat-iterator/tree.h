...
/************************************************************************************/
/*** Árbol Binario de Búsqueda implementado en forma iterativa con iterador pesado **/
/************************************************************************************/
...
public:
    ...
    /************************************************************************/
    /************* ITERADOR PESADO QUE RECORRE AL ÁRBOL EN ORDEN ************/
    /************************************************************************/
    ...
    public:
        ...
        iterator(node * current = nullptr) {
            m_current = find_minimum(current);
        }
